      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {courses.map((course, idx) => (
            <div 
              key={idx} 
              className="bg-brand-plum rounded-2xl p-8 md:p-12 flex flex-col justify-between border border-white/5"
            >
              <div>
              ...
              <div className="border-t border-white/10 pt-8 grid grid-cols-2 gap-y-6 gap-x-4">
                <div>
